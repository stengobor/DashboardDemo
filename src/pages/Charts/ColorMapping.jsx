...
const ColorMapping = () => {
  ...
  return (
    <div className="m-4 md:m-10 mt-24 p-10 bg-white dark:bg-secondary-dark-bg rounded-3xl" style={{ backgroundColor: currentColor }}>
      ...
      <div className="w-full">
        <ChartComponent
          ...
          tooltip={{ enable: true }}
          background={currentMode === 'Dark' ? 'none' : 'none'}
        >
